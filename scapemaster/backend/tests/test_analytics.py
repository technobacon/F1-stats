...
def test_summary_funnel_and_modes(client, monkeypatch):
    monkeypatch.setenv("OSRS_ANALYTICS_TOKEN", TOKEN)
    # Two visitors open; one completes a Slayer Task and shares; the other duels.
