...
backend/
  ...
  tests/           pytest suite (116): scoring, validation, api, auth, analytics, etl, dataset
...
frontend/
  index.html       HUD, modes, quiz, arcade, profile, leaderboards, modals, PWA tags
  app.js           guest-first state, server scoring, analytics tracker, share grid
